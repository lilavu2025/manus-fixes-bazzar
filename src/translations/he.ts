...
export const heTranslations = {
  ...
  uploadAdditionalImages: "העלה תמונות נוספות",
  categoryAndTags: "קטגוריה ותגים",
  stockAndStatus: "מלאי ומצב",
  tags: "תגיות",
  tagsPlaceholder: "הזן תגיות",
  ...
  bannerContent: "מכיל באנר",
  bannerSettings: "הגדרות באנר",
  imageAndStatus: "תמונה ומצב",
  ...
  actionPerformed: "פעולה שבוצעה",
  actionId: "מזהה פעולה",
  adminInfo: "מידע מנהל",
  whoPerformedAction: "מי ביצע את הפעולה",
  targetUser: "משתמש יעד",
  affectedUser: "משתמש שנפגע מהפעולה",
  changeDetails: "פרטי שינוי",
  whatChanged: "מה השתנה",
  changedField: "שדה שהשתנה",
  additionalDetails: "פרטים נוספים",
  moreInfo: "מידע נוסף על הפעולה",
  totalActivities: "סך הפעילויות",
  deletions: "מחיקות",
  disables: "השבתות",
  enables: "הפעלות",
  updates: "עדכונים",
  admins: "מנהלים",
  affectedUsers: "משתמשים מושפעים",
  noActivities: "אין פעילויות",
  noActivitiesDescription: "עדיין לא נרשמה פעילות מנהל",
  adminActivityDescription: "יומן של כל פעולות המנהל במערכת",
  dateAndDetails: "תאריך ופרטים",
  
  // Activity Log Dialog
  deletedUserInfo: "מידע משתמש שנמחק",
  userName: "שם משתמש",
  multipleUpdatesInfo: "מידע עדכונים מרובים",
  numberOfChanges: "מספר שינויים",
  operationType: "סוג פעולה",
  bulkOperation: "פעולה מרובה",
  bulkOperationNote: "מספר פריטים עודכנו באותו זמן",
  adminDetails: "פרטי מנהל",
  adminName: "שם מנהל",
  adminEmail: "אימייל מנהל",
  affectedUserDetails: "פרטי משתמש מושפע",
  userEmail: "אימייל משתמש",
  operationTime: "זמן פעולה",
  time: "זמן",
  otherInfo: "מידע אחר",
  relevantInfo: "מידע רלוונטי",
  noAdditionalInfo: "אין מידע נוסף זמין",
  ...
  currentValue: "ערך חדש",
  yes: "כן",
  no: "לא",
  
  // Activity Log Filters
  logFilters: "מסנני יומן",
  fromDate: "מתאריך",
  toDate: "עד תאריך",
  actionType: "סוג פעולה",
  searchInLog: "חיפוש ביומן",
  resetLogFilters: "איפוס מסננים",
  ...
  variants: "וריאציות",
  variantsNote: "הערה: ניתן לנהל וריאציות לאחר הוספת המוצר מרשימת המוצרים",
  manageVariants: "נהל וריאציות",
  manageProductVariants: "נהל וריאציות מוצר",
  selectVariant: "בחר מפרטים",
  pleaseSelectOption: "אנא בחר",
  pleaseSelectAllVariants: "אנא בחר את כל המפרטים הנדרשים",
  variantNotAvailable: "אפשרות זו אינה זמינה",
  moreOptionsAvailable: "אפשרויות נוספות זמינות",
  
  // Variant Management
  options: "אפשרויות",
  addNewOption: "הוסף אפשרות חדשה",
  optionName: "שם האפשרות",
  optionValues: "ערכי האפשרות",
  optionNamePlaceholder: "למשל: צבע, גודל",
  optionValuesPlaceholder: "אדום, כחול, ירוק",
  pleaseEnterOptionNameAndValues: "אנא הכנס שם אפשרות וערכים",
  pleaseEnterValidValues: "אנא הכנס ערכים תקינים",
  optionAdded: "אפשרות נוספה",
  optionDeleted: "אפשרות נמחקה",
  generateAllVariants: "צור את כל הוריאציות",
  pleaseAddOptionsFirst: "אנא הוסף אפשרויות תחילה",
  generating: "יוצר...",
  variantsGenerated: "וריאציות נוצרו",
  noVariantsYet: "אין וריאציות עדיין",
  addOptionsFirstThenGenerate: "הוסף אפשרויות תחילה ואז צור וריאציות",
  pleaseAddVariantsOrRemoveOptions: "אנא הוסף וריאציות או הסר אפשרויות",
  pleaseCompleteVariantData: "אנא השלם את כל נתוני הוריאציות",
  variantsSaved: "וריאציות נשמרו",
  errorSavingVariants: "שגיאה בשמירת וריאציות",
  variantDeleted: "וריאציה נמחקה",
  expand: "הרחב",
  collapse: "כווץ",
  variantImage: "תמונת וריאציה",
  uploadVariantImage: "העלה תמונת וריאציה",
  
  // Bulk Edit Features
  bulkEdit: "עריכה קבוצתית",
  bulkEditVariants: "עריכה קבוצתית של וריאציות",
  selectAll: "בחר הכל",
  selectNone: "בטל בחירה",
  selectedVariants: "וריאציות נבחרות",
  selectedVariant: "וריאציה נבחרת",
  applyToSelected: "החל על נבחרים",
  bulkPrice: "מחיר קבוצתי",
  bulkWholesalePrice: "מחיר סיטונאי קבוצתי",
  bulkStockQuantity: "כמות מלאי קבוצתית",
  bulkInStock: "זמינות קבוצתית",
  bulkActive: "פעילות קבוצתית",
  applyBulkChanges: "החל שינויים קבוצתיים",
  bulkChangesApplied: "שינויים קבוצתיים הוחלו",
  exitBulkEdit: "צא מעריכה קבוצתית",
  enableBulkEdit: "הפעל עריכה קבוצתית",
