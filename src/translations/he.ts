export const heTranslations = {
  ...
  areYouSureDeleteOrder: 'האם אתה בטוח שברצונך למחוק הזמנה זו? פעולה זו לא ניתנת לביטול.',
  ...
  deleteUserConfirmation: 'האם אתה בטוח שברצונך למחוק משתמש זה? פעולה זו לא ניתנת לביטול.',
