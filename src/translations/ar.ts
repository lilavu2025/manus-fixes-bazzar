export const arTranslations = {
  ...
  fillAllRequiredFieldsCarefully: 'يرجى تعبئة جميع الحقول المطلوبة بعناية. جميع الحقول بعلامة * مطلوبة.',
  customer: 'العميل',
  ...
  orderCreatedFromAdminPanel: 'سيتم تمييز هذه الطلبية أنها أُنشئت من لوحة التحكم',
  ...
  november: 'نوفمبر',
  december: 'ديسمبر',
  fillAllRequiredFields: 'يرجى تعبئة جميع الحقول المطلوبة بعناية. جميع الحقول بعلامة * مطلوبة.',
  ...
  passwordChangeHint: 'يرجى إدخال كلمة المرور الحالية وكلمة المرور الجديدة لتغييرها.',
